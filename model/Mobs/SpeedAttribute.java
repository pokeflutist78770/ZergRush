...
public enum SpeedAttribute {
	...
	SLOW(ControllerMain.GUI_SIZE / 600-.3),
	NORMAL(ControllerMain.GUI_SIZE / 600),  //1.25
	FAST(ControllerMain.GUI_SIZE / 600+1.5),  //1.5
	VERY_FAST(4*ControllerMain.GUI_SIZE/ 600+1.75),
